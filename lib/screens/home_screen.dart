...
class _HomeScreenState extends State<HomeScreen> {
  int _selectedIndex = 0; // Home = 0, Perfil = 1
      ...
      return [
        {
          'titulo': 'Obesidade',
          'descricao':
              'O excesso de peso pode causar vários problemas de saúde a longo prazo.',
          'especialista': 'Nutricionista ou Endocrinologista'
        },
        {
          'titulo': 'Depressão',
          'descricao':
              'Distúrbio emocional que afeta o humor e pode impactar o bem-estar geral.',
      ...
      return [
        {
          'titulo': 'Diabetes',
          'descricao':
              'Alteração no metabolismo da glicose que pode causar danos se não tratada.',
      ...
      return [
        {
          ...
          'descricao':
              'Muito comum após os 50 anos. Diagnóstico precoce é essencial.',
          'especialista': 'Urologista'
        },
        {
          'titulo': 'Diabetes',
          'descricao':
              'Alteração no metabolismo da glicose que pode causar danos graves.',
          'especialista': 'Endocrinologista'
        },
        {
          'titulo': 'Hipertensão',
